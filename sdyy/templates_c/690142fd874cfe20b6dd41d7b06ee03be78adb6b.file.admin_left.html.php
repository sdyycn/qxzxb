...
<?php /*%%SmartyHeaderCode:2132951e8f346912d27-39163958%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2132951e8f346912d27-39163958',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_51e8f3469a21e7_02934600',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e8f3469a21e7_02934600')) {function content_51e8f3469a21e7_02934600($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="left_contain">
 ...
 <ul id="id1_ul" style="display:none">
  <li><a href="site.php?page=info" target="main">站点设置</a></li>
  <li><a href="site.php?page=sys" target="main">系统设置</a></li>
  <li><a href="site.php?page=lang" target="main">语言设置</a></li>
  <li><a href="site.php?page=home" target="main">首页设置</a></li>
  <li><a href="site.php?page=market" target="main">营销工具</a></li>
  <li><a href="site.php?page=keywords" target="main">关键词设置</a></li>
  <li><a href="site.php?page=flashmanage" target="main">首页主广告管理</a></li>
  <li><a href="site.php?page=flashconfig" target="main">首页主广告设置</a></li>
 </ul>
 ...
 <ul id="id4_ul" style="display:none">
  <li><a href="user.php?page=admin" target="main">管理员管理</a></li>
  <li><a href="user.php?page=admingroup" target="main">管理员分组</a></li>
  <li><a href="user.php?page=user" target="main">会员管理</a></li>
  <li><a href="user.php?page=usergroup" target="main">会员分组</a></li>
 </ul>
 ...
 <ul id="id8_ul" style="display:none">
  <li><a href="link.php?page=add" target="main">添加链接</a></li>
  <li><a href="link.php?page=list" target="main">管理链接</a></li>
 </ul>
 <h2 rel="id9_ul"><p><span>数据管理</span></p></h2>
 <ul id="id9_ul" style="display:none">
  <li><a href="data.php" target="main">备份数据</a></li>
  <li><a href="data.php?page=restore" target="main">恢复数据</a></li>
 </ul>
 <h2 rel="id10_ul"><p><span>留言管理</span></p></h2>
 <ul id="id10_ul" style="display:none">
  <li><a href="guestbook.php?page=setting" target="main">设置</a></li>
  <li><a href="guestbook.php?page=list" target="main">管理留言</a></li>
 </ul>
