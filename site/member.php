...
if($action=='ajax_login'){
	...
	$str=$_SESSION['member_user']."&nbsp;{$language['member_wel']}&nbsp;<a href=\"".CMS_SELF."member.php?action=main&lang=".$lang."\">".$language['member_msg28']."</a>|<a href=\"".CMS_SELF."member.php?action=out&lang=".$lang."\">{$language['member_out']}</a>";
