	...
	<div class="contain_left">
		...
		<div class="box_right"></div>
			...
			<div class="box_in">
				<ul class="nav_list">
				<?php 
 if(isset($list_down_nav)&&is_array($list_down_nav)){
foreach($list_down_nav as $v){?>
		...
		<div class="div_margin"></div>
			...
			<div class="box_in">
				<div class="list_news">
					<ul>
					<?php 
 if(isset($list_down_article)&&is_array($list_down_article)){
foreach($list_down_article as $v){?>
		...
		<div class="div_margin"></div>
			...
			<div class="box_in">
				<div class="list_product">
					<ul>
					 <?php 
 if(isset($list_down_product)&&is_array($list_down_product)){
foreach($list_down_product as $v){?>
