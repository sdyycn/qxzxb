...
<title>新闻中心_汽车转向泵,齿轮泵,叶片泵-绍兴县申达液压机械厂,申达液压机械厂,Shenda Hydraulic Machinery Factory, Power Steering Pump</title>
...
<div class="contain">
	...
	<div class="contain_right">
		...
		<div class="box">
			<div class="box_left"></div>
			<div class="box_right"></div>
			<div class="box_title"><h2 class="position"><span>当前位置:<a href="/index.php?lang=cn">首页</a> > <a href="/show_list.php?id=6">新闻中心</a> > 列表页</span></h2></div>
			<div class="box_in">
				<ul class="ul_list_article">
  											<li class="list_info">
				<dl>
					<dt><span class="title"><a href="/show_content.php?id=61" ><font style="color:rgb(254, 0, 0);font-weight:bold;">新产品成功上市-20120211-B</font></a></span></dt>
					<dd><p class="in_pic"><img src="/upload/no_pc.gif" height="60" width="60" border="0" /></p><p class="in_text"></p></dd>
				</dl>
				<div class="clear"></div>
			</li>
															<li><span class="time">2012-02-11 	10:02:43</span><a href="/show_content.php?id=60" ><font style="color:rgb(254, 0, 0);font-weight:bold;">新产品成功上市-20120211-A</font></a></li>
																<li><span class="time">2011-06-01 	19:06:58</span><a href="/show_content.php?id=4" ><font style="color:#fe0000;font-weight:bold;">热烈祝贺企业网站正式启用!</font></a></li>
								  				</ul>
 				 <div class="list_page">
   				<ul>
    			<li><a href="show_list.php?page=1&id=6">首页</a></li><li><a href="#">上一页</a></li><li class="focus"><a href="show_list.php?page=1&id=6">1</a></li><li><a href="#">下一页</a></li><li><a href="show_list.php?page=1&id=6">尾页</a></li><li>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"><option value="?page=1&id=6" selected="selected">1</option></select></li><li>共3条记录,当前第1/1</li>   				</ul>
  				</div>
				<div class="clear"></div>
			</div>
		</div><!--容器结束-->
