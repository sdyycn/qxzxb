...
<title>公司简介_汽车转向泵,齿轮泵,叶片泵-绍兴县申达液压机械厂,申达液压机械厂,Shenda Hydraulic Machinery Factory, Power Steering Pump</title>
...
<div class="contain">
	...
	<div class="contain_right">
		...
		<div class="box">
			<div class="box_left"></div>
			<div class="box_right"></div>
			<div class="box_title"><h2 class="position"><span>当前位置:<a href="/index.php?lang=cn">首页</a> > <a href="/show_list.php?id=12">公司简介</a> > 列表页</span></h2></div>
			<div class="box_in">
				<ul class="ul_list_article">
  				  				</ul>
 				 <div class="list_page">
   				<ul>
    			<li><a href="show_list.php?page=1&id=12">首页</a></li><li><a href="#">上一页</a></li><li><a href="#">下一页</a></li><li><a href="show_list.php?page=0&id=12">尾页</a></li><li>转到<select style="width:40px;" onchange="location.href=this.options[this.selectedIndex].value;"></select></li><li>共0条记录,当前第1/0</li>   				</ul>
  				</div>
				<div class="clear"></div>
			</div>
		</div><!--容器结束-->
