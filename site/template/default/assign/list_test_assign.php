...
$tpl->assign('list_nav',get_list_nav('list_nav1'));//文章列表页导航
$tpl->assign('list_link',get_block('list_link'));//文章列表页联系我们
$tpl->assign('list_article',get_article('list_article'));//热门内容
$tpl->assign('list_product',get_article('list_product'));//推荐产品
