...
$tpl->assign('list_pr_nav',get_list_nav('list_pr_nav1'));//产品列表页导航们
$tpl->assign('list_pr_link',get_block('list_pr_link'));//产品列表页联系我们
$tpl->assign('list_pr_article',get_article('list_pr_article'));//产品列表页热门内容
$tpl->assign('list_pr_product',get_article('list_pr_product'));//产品列表页推荐产品
