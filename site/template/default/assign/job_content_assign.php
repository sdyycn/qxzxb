...
$tpl->assign('job_arc_nav',get_list_nav('job_arc_nav'));//内容页导航
$tpl->assign('job_arc_link',get_block('job_arc_link'));//联系我们
$tpl->assign('job_arc_article',get_article('job_arc_article'));//热门内容
$tpl->assign('job_arc_product',get_article('job_arc_product'));//推荐产品
