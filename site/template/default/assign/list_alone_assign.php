...
$tpl->assign('alone_nav',get_list_nav('alone_nav'));//列表页导航
$tpl->assign('alone_link',get_block('alone_link'));//联系我们
$tpl->assign('alone_article',get_article('alone_article'));//热门内容
$tpl->assign('alone_product',get_article('alone_product'));//推荐产品
