...
$tpl->assign('list_down_nav',get_list_nav('list_down_nav1'));//列表页导航
$tpl->assign('list_down_link',get_block('list_down_link'));//列表页联系我们
$tpl->assign('list_down_article',get_article('list_down_article'));//热门内容
$tpl->assign('list_down_product',get_article('list_down_product'));//推荐产品
