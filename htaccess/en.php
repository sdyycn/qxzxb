...
<div id="wrapperAll">
<h1><a href="en.php"><img src="share/images/common_files/logo_en.gif" alt=".htaccess Editor" width="300" height="60" /></a></h1>
<ul id="globalNavi"><li id="siteHome"><a href="en.php" title=".htaccess create">.htaccess create</a></li></ul>

<div id="language">
<select onchange='location=this.options[this.selectedIndex].value;'>
<option value="en.php" selected="selected"> English </option>
